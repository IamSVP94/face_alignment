...
def main(args):
    ...
    for img_idx, img_path in enumerate(imgs_bar):
        ...
        if annot_path.exists():
            ...
            crop_path = args.dst_dir / img_path.name
            annot_path = crop_path.with_suffix('.pts')

            # http://dlib.net/python/index.html#dlib_pybind11.fhog_object_detector.run
...
if __name__ == '__main__':
    ...
    args.dst_dir = Path(
        args.dst_dir).resolve() if args.dst_dir else args.src_dir.parent / f'{args.src_dir.name}_dataset'
